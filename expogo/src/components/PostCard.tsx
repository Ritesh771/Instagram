...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
  ...
  const handleGoToProfile = () => {
    ...
    // 👆 assumes you have a "Profile" screen expecting { userId }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.userInfo}>
          <LinearGradient colors={["#E1306C", "#F56040"]} style={styles.avatar}>
...
const styles = StyleSheet.create({
  ...
  imageContainer: { width: "100%", aspectRatio: 1, justifyContent: "center", alignItems: "center" },
  ...
  captionContainer: { paddingHorizontal: 16, paddingBottom: 16 },
  caption: { fontSize: 14, lineHeight: 20 },
  usernameText: { fontWeight: "600", color: "#212529" },
  captionText: { color: "#212529" },
  likesContainer: { paddingHorizontal: 16, paddingBottom: 8 },
  likesText: { fontSize: 14, fontWeight: "600", color: "#212529" },
});
